...
public class user_view_status extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener{
    ListView l1;
    String s;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) user_view_status.this;
        String q = "/user_view_status?lid=" + sh.getString("log_id", "");
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
...
//
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
        ...
        if (s.equalsIgnoreCase("paid")) {
            final CharSequence[] items = {"View Maps","Cancel"};

            AlertDialog.Builder builder = new AlertDialog.Builder(user_view_status.this);
