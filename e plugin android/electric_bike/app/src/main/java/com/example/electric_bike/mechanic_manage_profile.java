...
public class mechanic_manage_profile extends AppCompatActivity implements JsonResponse{
    EditText e1,e2,e3,e4,e5;
    Button b1;
    String firstname,lastname,place,phone,email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response=(JsonResponse)mechanic_manage_profile.this;
        String q="/mechanic_view_profile?lid="+sh.getString("log_id","");
        q=q.replace(" ","%20");
        JR.execute(q);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JsonReq JR=new JsonReq();
                JR.json_response=(JsonResponse)mechanic_manage_profile.this;
                String q="/mechanic_update_profile?lid="+sh.getString("log_id","")+"&firstname="+firstname+"&lastname="+lastname+"&place="+place+"&phone="+phone+"&email="+email+"&latitude="+LocationService.lati+"&longitude="+LocationService.logi;
                q=q.replace(" ","%20");
                JR.execute(q);
            }
        });
    ...
    public void response(JSONObject jo) {
        ...
        try {
            ...
            if(method.equalsIgnoreCase("mechanic_update_profile")) {
            ...
            else if(method.equalsIgnoreCase("mechanic_view_profile"))
            {
                String status=jo.getString("status");
                Log.d("pearl",status);
