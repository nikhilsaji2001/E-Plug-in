...
public class user_pay_amount extends AppCompatActivity implements JsonResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e4.setText(user_view_oredereditem.amounts);
        e4.setEnabled(false);
...
//
                ...
                String q="/user_pay_amount?lid="+sh.getString("log_id","")+"&amount="+user_view_oredereditem.amounts+"&oid="+user_view_oredereditem.oids;
                q=q.replace(" ","%20");
                JR.execute(q);
            }
        });
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(status.equalsIgnoreCase("success")){
                ...
                startActivity(new Intent(getApplicationContext(),user_view_oredereditem.class));
